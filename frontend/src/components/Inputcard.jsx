    ...
    >
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          type="submit"
          className="bg-gradient-to-r from-indigo-600 via-blue-500 to-blue-500 text-white py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
        >
          Predict Route
        </motion.button>
      </form>
