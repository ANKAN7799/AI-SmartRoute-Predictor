...
# WEATHER_API_KEY = "APIKEY2"  # Replace with your actual key
...
CORS(app, resources={r"/*": {"origins": [
    "http://localhost:5173",
    "http://localhost:3000",
    "https://ai-smart-route-predictor.vercel.app/"  # Your actual Vercel URL
]}})
...
def health():
    ...
    return jsonify({
        ...
        "encoder_loaded": weather_encoder is not None,
        "api_keys_set": bool(ORS_API_KEY and WEATHER_API_KEY)
    })
